...
const FIRE_TRIGGER_VIDEO =
  "https://aispbvvuiuuluzzpkkml.supabase.co/storage/v1/object/public/Website%20Content/Trigger%20fire%20video%20.mov";
      ...
      >
        <div className="absolute inset-0 flex items-center justify-center p-6 bg-[#0a1628]">
          <div className="w-full max-w-md rounded-2xl border border-white/15 bg-[#13243f] p-6 shadow-2xl">
            <div className="text-[11px] tracking-[0.25em] text-[#ff7ab6] font-bold mb-3">
              FIRE TRIGGER VIDEO
            </div>
            <a
              href={FIRE_TRIGGER_VIDEO}
              target="_blank"
